...
function getInfoBasedOnScore(){
    if(totalScore() < 20){
        var score_info = "Parabéns! Você é como um tigre, agil, forte e extremamente letal!";
        imagem.setAttribute('src', 'tigre.jpg')
    } else if(totalScore() >= 21 < 40){
        var score_info = "Parabéns! Você é como o grande leão, magestoso e motal!"
        imagem.setAttribute('src', 'leão.jpg')
    }
    else if(totalScore() >= 41 < 60){
        var score_info = "Parabéns! Você é como um panda, calmo e sereno!"
        imagem.setAttribute('src', 'panda.JPG')
    }
    else if(totalScore() >= 61 < 80){
        var score_info = "Parabéns! Você é como uma coruja, agil e esperta!"
        imagem.setAttribute('src', 'coruja.jpg')
    }
    else {
        var score_info = "Parabéns! Você é como um tubarão, silencioso e misterioso!"
        imagem.setAttribute('src', 'tubarão.jpg')
    }
